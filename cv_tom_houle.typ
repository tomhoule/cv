...
#let graphql-conf-talks = "https://www.tomhoule.com/graphql-conf-amsterdam/"
...
- Engaged in hiring for ICs, Engineering and Product Managers, mentoring and formal feedback rounds.
...
- Led high impact projects: native types support, Postgres extensions, isolating the query planner, ...
]
...
- Took an active part in infrastructure work, migrating from Heroku to Kubernetes and Terraform.
]
...
- Developed new internal web applications, new public-facing websites and enhanced older websites as the single full-time developer in a heritage-focused company working mostly for the
  public sector.
- Took on other tasks occasionally: web scraping, batch data manipulation...
- Python (Django), React, Typescript, PHP, PostgreSQL, Ansible, Jenkins, Docker.
]
...
#interest[Long lived interest in *database engines* and database engineering in general.]
#interest[
...
#degree(
  ...
  degree: "Master’s Degree in Tourism Management",
)
